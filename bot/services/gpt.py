...
Формат відповіді:
Поверни ЛИШЕ готовий текст пісні. Використовуй мітки структури мовою тексту:
- для української мови: [Куплет 1], [Приспів], [Куплет 2], [Кінцівка]
- для російської мови: [Куплет 1], [Припев], [Куплет 2], [Концовка]
Цей текст напряму вставляється в Suno для генерації музики. Не додавай жодних вступних фраз, пояснень, привітань, лапок чи коментарів — тільки сам текст пісні з мітками, готовий для копіювання.\
"""
